...
if __name__ == "__main__":
    ...
    # Uncomment to generate a new dataset
    """
    ...
    # STEP 2: Define and run the prompt you want to evaluate
...
"""
    ...
    # STEP 3: Run evaluation on the dataset
    # Uncomment to run evaluation
    """
    results = evaluator.run_evaluation(
        run_prompt_function=run_prompt,
        dataset_file="Prompt_dataset.json",
        extra_criteria='''
